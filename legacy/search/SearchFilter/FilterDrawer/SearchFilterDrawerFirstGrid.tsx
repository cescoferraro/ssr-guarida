...
import { CaracteristicasFilter } from "legacy/search/SearchFilter/FilterDrawer/CaracteristicasFilter";
import { CategoryFilter } from "legacy/search/SearchFilter/FilterDrawer/CategoryFilter";
...
import { FinalidadeFilter } from "legacy/search/SearchFilter/FilterDrawer/FinalidadeFilter";
...
export const SearchFilterDrawerFirstGrid: React.FC<{
  ...
  const { data } = useGuaridaCategorias(drawerState, "britney");
  return (
